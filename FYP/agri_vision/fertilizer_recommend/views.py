...
fertilizer_mapping = {
    0: '10-10-10', 1: '10-26-26', 2: '14-14-14', 3: '14-35-14', 4: '15-15-15', 5: '17-17-17',
    6: '20-20', 7: '28-28', 8: 'DAP', 9: 'Potassium chloride', 10: 'Potassium sulfate.',
...
def recommend_ferti(request):
    ...
    if request.method == 'POST':
        try:
            ...
            scaler_model = joblib.load(r'C:\Users\Lkumar\OneDrive - OPENMYNZ SOFTLABS PRIVATE LIMITED\Desktop\FYP\Fertilizer_scaler.pkl')

            # Scale the numerical features (using already fitted scaler)
            numerical_features_scaled = scaler_model.transform([numerical_features]) # Use transform instead of fit_transform
            print(f"Scaled Values: {numerical_features_scaled}")
    
            # Prepare the input data for prediction
            input_data = numerical_features_scaled.flatten().tolist() + [soil_type, crop_type]
            ...
            model = joblib.load(r'C:\Users\Lkumar\OneDrive - OPENMYNZ SOFTLABS PRIVATE LIMITED\Desktop\FYP\Fertilizer_Recommend.pkl')
